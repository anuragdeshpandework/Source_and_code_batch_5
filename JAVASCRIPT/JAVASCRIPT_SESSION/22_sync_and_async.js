...
// 1 CALLBACK HELL (OLD WAY) --> in method the async code is placed in callback function 
// due to it it becomes valid that the function waits unitl the other completed
