...
let price = 299.99;
console.log(Math.ceil(price)) //output==> 300



// 3. Create a string `name` with your full name and log the length of the string using the `.length` property.

let  name = "Swapnil Valmik Sangle"
console.log(name.length) //output==> 26
...
let middleName = "Valmik"
let lastName = "Sangle"
// using + operator
let fullName1 = firstName +" "+ middleName +" "+ lastName
// using template literals
let fullName2 = `${firstName} ${middleName} ${lastName}`
console.log(fullName1) //output==> Swapnil Valmik Sangle
console.log(fullName2) //output==> Swapnil Valmik Sangle
...
// 9. Write a program that declares a variable `amount = 47.95`, then uses `Math.floor()`, `Math.ceil()`, and `Math.round()` on this value and logs each result.

let amount = 47.95
console.log(Math.floor(amount))//output ==>47
console.log(Math.ceil(amount))//output ==>48
console.log(Math.round(amount))//output ==>48
...
// 12. Create a string variable `str = 'Hello, Guys!'` and use an escape character to insert a tab between the words "Hello," and "World!" and log the result.

let str = 'Hello,\tGuys!'
console.log(str) // output ==> Hello,  Guys!

// 13. Given two variables, `str1 = 'swa'` and `str2 = 'san'`, write a program to concatenate these two strings using both the `+` operator and template literals. Log both results.
let str1 = 'swa';
let str2 = 'san';
...
console.log(small1) //output ==> swasan
console.log(small2) //output ==> swasan 
